...
heading_label = tk.Label(root, text="Calculator", font=("Helvetica", 16, "bold"))
heading_label.grid(row=0, column=0, columnspan=4, pady=20, sticky="nsew")
...
root.geometry("400x600")  # Initial size
root.minsize(300, 400)   # Minimum size
